-- COPIED from dooing/lua/dooing/sync/httpd.lua — the two plugins share
-- this server core by COPYING, never by require(): each product must
-- work with the other deleted from disk (masterplan Part 0a). Fix bugs
-- there first, then re-copy.
