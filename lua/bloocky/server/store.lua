-- COPIED from dooing/lua/dooing/sync/store.lua and repathed (see
...
function M.path()
	...
	local save_path = config.options.save_path or (vim.fn.stdpath("data") .. "/bloocky_blocks.json")
	return vim.fn.fnamemodify(save_path, ":h") .. "/bloocky_app_sync.json"
end
